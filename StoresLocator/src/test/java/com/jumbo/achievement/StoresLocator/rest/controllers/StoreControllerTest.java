...
public class StoreControllerTest {
    ...
    private ArrayList<ComplexStore> getFoundStoresList() {
        ArrayList<ComplexStore> stores = new ArrayList<>();
        ...
        ComplexStore complexStore2 = new ComplexStore(1.08, store3);
        ComplexStore complexStore3 = new ComplexStore(1.09, store2);
        stores.add(complexStore1);
        stores.add(complexStore2);
        stores.add(complexStore3);
        return stores;
    }
}
